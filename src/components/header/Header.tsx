...
const Header: React.FC<HeaderProps> = ({ onClick, onToggle }) => {
  ...
  return (
    ...
    <header className="sticky top-0 flex  bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6 max-w-(--breakpoint-2xl)">
