    ...
    <div className="max-w-7xl mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <div className="flex flex-wrap gap-4 mb-6">
        <div className="flex flex-col w-full sm:w-1/5">
          ...
          <select value={selectedStatusFilter} onChange={handleStatusFilterChange} className="p-3 border rounded-lg">
      ...
      <div className="flex flex-wrap sm:flex-nowrap items-end gap-4 mb-6">
        ...
        <div className="flex gap-2 mt-6 sm:mt-0 w-full sm:w-[100%]">
          <button onClick={handleExport} className="px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700">
            Export to Excel
          </button>
        </div>
              ...
              if (pageNum <= totalPages) {
                return (
                  <button
                    ...
                    className={`px-3 py-1 border rounded ${currentPage === pageNum ? "bg-blue-600 text-white" : "hover:bg-gray-100"}`}
                  >
                    {pageNum}
                  </button>
                )
          ...
          <div className="bg-white w-full max-w-2xl p-6 rounded-lg shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              <div className="flex gap-2">
                ...
                <p className="bg-gray-100 rounded">{selectedInquiry.createdAt || "N/A"}</p>
              </div>

              <div className="flex gap-2">
                <label className="mb-1 font-medium text-gray-600">Last Updated:</label>
                <p className="bg-gray-100 rounded">{selectedInquiry.updatedAt || "N/A"}</p>
              </div>
            </div>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-opacity-50 bg-[#00000071] backdrop-blur-xs">
          <div className="bg-white w-full max-w-md p-6 rounded-lg shadow-lg">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col">
                <label className="mb-1 font-medium">
                  {isFollowUpUser ? "Reassign Follow-up User" : "Select Follow-up Quotation User"}
                </label>
                <Select
                  name="followUpUser"
                  value={selectedFollowUpUser}
