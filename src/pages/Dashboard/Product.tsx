...
const Product = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`https://nicoindustrial.com/api/product/create`, payload, { headers: { Authorization: `Bearer ${token}` } });
      ...
      const errorMessage = (error as any).response?.data?.message || "Error creating product. Please try again.";
