  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage =
        ...
        (editingProduct ? "Error updating product. Please try again." : "Error creating product. Please try again.")
        ...
        {filteredProducts.length > 0 && (
          <div className="flex justify-between items-center mt-6">
            <p className="text-sm text-gray-600">
              Showing {startIndex + 1} to {Math.min(startIndex + productsPerPage, filteredProducts.length)} of{" "}
